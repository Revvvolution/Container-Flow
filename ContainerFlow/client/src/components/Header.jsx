...
export default function Header(isLoggedIn, setIsLoggedIn) {
  ...
  return (
    <header className="sm:bg-none flex flex-row items-center justify-between border-4 border-yellow-800/40 w-[100vw] px-1 mt-0.5 bg-gradient-to-b from-cyan-600/75 via-cyan-700/20 to-cyan-500/60 md:h-20 md:bg-cyan-600 sm:justify-around col-span-2 p-2 border-b-2 -z-10">
            <a
                href="/"
      ...
      <nav className="sm:hidden flex flex-col items-end gap-1 font-semibold">
        ...
        {showMenu && (
          <>
            <a href="/" className="hover:text-gray-200 pt-14 pb-2 border-b-2 border-b-slate-950/50 w-[100vw]">
                Home
            </a>
            <a href="/" className="hover:text-gray-200 pb-2 border-b-2 border-b-slate-950/50 w-[100vw]">
                Containers
            </a>
            <a href="/" className="hover:text-gray-200 pb-2 border-b-2 border-b-slate-950/50 w-[100vw]">
                Items
